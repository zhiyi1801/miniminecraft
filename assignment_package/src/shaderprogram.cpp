...
void ShaderProgram::create(const char *vertfile, const char *fragfile, const char *geomfile)
{
    ...
    if(geomfile)
    {
        ...
        qGeomSource = qTextFileRead(geomfile);
        geomSource = new char[qGeomSource.size() + 1];
        strcpy(geomSource, qGeomSource.toStdString().c_str());
        context->glShaderSource(geomShader, 1, (const char**)&geomSource, 0);
    ...
    unifSampler2D = context->glGetUniformLocation(prog, "u_Sampler2D");
...
void ShaderProgram::drawInterleaved(Drawable &d)
{
    ...
    if(d.bindAll())
    {
        ...
        if (attrCol != -1) {
            context->glEnableVertexAttribArray(attrCol);
            context->glVertexAttribPointer(attrCol, 4, GL_FLOAT, false, 3 * sizeof(glm::vec4), (void*)(1 * sizeof(glm::vec4)));
        }
...
void ShaderProgram::setSampler2D(int slot)
{
    useMe();
...
{
    useMe();
    context->glUniform1i(context->glGetUniformLocation(prog, name.c_str()), (int)value);
}
// ------------------------------------------------------------------------
void ShaderProgram::setInt(const std::string &name, int value) const
{
    useMe();
    context->glUniform1i(context->glGetUniformLocation(prog, name.c_str()), value);
}
// ------------------------------------------------------------------------
void ShaderProgram::setFloat(const std::string &name, float value) const
{
    useMe();
    context->glUniform1f(context->glGetUniformLocation(prog, name.c_str()), value);
}
// ------------------------------------------------------------------------
void ShaderProgram::setVec2(const std::string &name, const glm::vec2 &value) const
{
    useMe();
    context->glUniform2fv(context->glGetUniformLocation(prog, name.c_str()), 1, &value[0]);
}
void ShaderProgram::setVec2(const std::string &name, float x, float y) const
{
    useMe();
    context->glUniform2f(context->glGetUniformLocation(prog, name.c_str()), x, y);
}
// ------------------------------------------------------------------------
void ShaderProgram::setVec3(const std::string &name, const glm::vec3 &value) const
{
    useMe();
    context->glUniform3fv(context->glGetUniformLocation(prog, name.c_str()), 1, &value[0]);
}
void ShaderProgram::setVec3(const std::string &name, float x, float y, float z) const
{
    useMe();
    context->glUniform3f(context->glGetUniformLocation(prog, name.c_str()), x, y, z);
}
// ------------------------------------------------------------------------
void ShaderProgram::setVec4(const std::string &name, const glm::vec4 &value) const
{
    useMe();
    context->glUniform4fv(context->glGetUniformLocation(prog, name.c_str()), 1, &value[0]);
}
void ShaderProgram::setVec4(const std::string &name, float x, float y, float z, float w)
{
    useMe();
    context->glUniform4f(context->glGetUniformLocation(prog, name.c_str()), x, y, z, w);
}
// ------------------------------------------------------------------------
void ShaderProgram::setMat2(const std::string &name, const glm::mat2 &mat) const
{
    useMe();
    context->glUniformMatrix2fv(context->glGetUniformLocation(prog, name.c_str()), 1, GL_FALSE, &mat[0][0]);
}
// ------------------------------------------------------------------------
void ShaderProgram::setMat3(const std::string &name, const glm::mat3 &mat) const
{
    useMe();
    context->glUniformMatrix3fv(context->glGetUniformLocation(prog, name.c_str()), 1, GL_FALSE, &mat[0][0]);
}
// ------------------------------------------------------------------------
void ShaderProgram::setMat4(const std::string &name, const glm::mat4 &mat) const
{
    useMe();
    context->glUniformMatrix4fv(context->glGetUniformLocation(prog, name.c_str()), 1, GL_FALSE, &mat[0][0]);
}
