...
Drawable::Drawable(OpenGLContext* context)
    ...
    m_allGenerated(false), m_transGenerated(false), m_transIdxGenerated(false),
      mp_context(context)
{}
...
void Drawable::destroyVBOdata()
{
    ...
    m_allGenerated = m_transGenerated = m_transIdxGenerated = m_idxGenerated = m_posGenerated = m_norGenerated = m_colGenerated = false;
    m_count = -1;
    m_transCount = -1;
}
